...
const Register = () => {
  ...
  const [teacherType, setTeacherType] = useState("BBA");
  const [ifTeacher, setIfTeacher] = useState(false);
  ...
  return (
          ...
          <Col md={6} className="mx-auto mt-4 ">
            <Paper className="p-4 shadow rounded">
              ...
              <Form onSubmit={formSubmitHandler}>
                ...
                <Form.Group>
                <Form.Label>Student/Teacher</Form.Label>  
                <>   </>
    ...
    <Form.Group>
                ...
                <> </>
                <select value={teacherType} onChange={handleTeacherTypeChange}>
