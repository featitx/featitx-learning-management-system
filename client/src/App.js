...
import AddQuiz from "./pages/Teacher/AddQuiz/QuizCreator";
...
import AuthorizeUserInfo from "./pages/Admin/AuthorizeUser/AuthorizeUserInfo";
...
const Routing = () => {
  ...
  return (
    <Switch>
      ...
      <StudentRoute exact path="/main-quiz/:id">
        <QuizMain />
      </StudentRoute>
      ...
      <TeacherRoute exact path="/addQuiz">
        <AddQuiz />
      </TeacherRoute>
      ...
      <AdminRoute exact path="/admin/teacher-info">
        ...
        <AdminRoute exact path="/admin/Authorize-UserInfo">
        <AuthorizeUserInfo />
      </AdminRoute>
      ...
      <Route exact path="/course/:courseId/:viewAll">
        <CourseInfo />
      </Route>
